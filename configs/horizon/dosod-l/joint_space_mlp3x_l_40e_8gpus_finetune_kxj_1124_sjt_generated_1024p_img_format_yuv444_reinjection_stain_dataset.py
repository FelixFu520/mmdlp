...
coco_train_dataset = dict(
    ...
    dataset=dict(
        ann_file='real_virtual_resize_coco_jpg_20241124.json',
    ...
    pipeline=[
        ...
        dict(
            ...
            type='NV12ToYUV444Transformer',
            yuv444_output_layout='HWC'),
        dict(
            max_num_samples=5,
            num_neg_samples=(
                5,
...
launcher = 'pytorch'
load_from = '/horizon-bucket/d-robotics-bucket/shiyuan.chen/workspace/train_jobs/kexuejia/joint_space_mlp3x_l_40e_8gpus_finetune_kxj_1124_sjt_generated_1024p_img_format_yuv444/2024_12_05_01_02_12/epoch_30.pth'
log_level = 'INFO'
...
weight_decay = 0.05
widen_factor = 1.0
work_dir = '/horizon-bucket/d-robotics-bucket/shiyuan.chen/workspace/train_jobs/kexuejia/joint_space_mlp3x_l_40e_8gpus_finetune_kxj_1124_sjt_generated_1024p_img_format_yuv444/2024_12_05_01_02_12'
