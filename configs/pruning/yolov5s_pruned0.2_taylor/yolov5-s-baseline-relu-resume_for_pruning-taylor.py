...
log_level = 'INFO'
load_from = "/home/users/fa.fu/work/work_dirs/yolov5-s/epoch_300.pth"
resume = True
pruning_channels = dict(type="mmdlp.AfterTrainPruning", pruning_algorithm="taylor", 
                        pruning_ratio=0.2, ignore_layers_name=["data_preprocessor", 'head'])
...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        rule=None,
        max_keep_ckpts=-1),
    pruning_channels=pruning_channels,
    )
custom_hooks = [
    dict(
        type='EMAHook',
