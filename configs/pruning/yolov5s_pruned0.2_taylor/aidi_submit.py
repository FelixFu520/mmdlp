...
taskname = "fafu_yolov5_s_finetune_taylor"
...
dag = client.dag.new_dag(
    ...
    code_package=CodePackageConfig(
            raw_package=LocalPackageItem(
                lpath="/home/users/fa.fu/work/mmdlp", encrypt_passwd="123765", follow_softlink=False
            ),
        ),
...
train = dag.new_job(
    ...
    startup=StartUpConfig(
        command="bash /running_package/code_package/configs/pruning/yolov5s_pruned0.2_taylor/aidi_submit.sh",
