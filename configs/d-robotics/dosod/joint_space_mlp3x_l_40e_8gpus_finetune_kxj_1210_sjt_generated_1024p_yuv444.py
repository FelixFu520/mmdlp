...
coco_val_dataset = dict(
    ...
    class_text_path='data/texts/kxj_class_texts_1204.json',
    dataset=dict(
        ann_file='real_resize_coco_jpg_20241204.json',
        data_prefix=dict(img=''),
        data_root=
...
test_evaluator = dict(
    ann_file=
    '/horizon-bucket/d-robotics-bucket/AIOT_algorithm_data/test_stain_dataset/real_resize_coco_jpg_20241204.json',
    classwise=True,
    metric='bbox',
    pr_plot=True,
    proposal_nums=(
...
weight_decay = 0.05
widen_factor = 1.0
work_dir = '/horizon-bucket/d-robotics-bucket/shiyuan.chen/workspace/train_jobs/kexuejia/joint_space_mlp3x_l_40e_8gpus_finetune_kxj_1210_sjt_generated_1024p_yuv444/2024_12_10_19_04_18'
