...
default_hooks = dict(
    ...
    pruning_channels=dict(type="mmdlp.MagnitudePruner", pruning_ratio=0.3, pruning_lr_scale=1, by_epoch=True, epoch_times=[205, 210, 215], ignore_layers_name=["head.fc", "data_preprocessor"]),
