...
backend_args = None
base_lr = 0.01 * 0.5  # Base learning rate for optim_wrapper. Corresponding to 8xb16=128 bs
...
log_level = 'INFO'
load_from = "/home/users/fa.fu/work/epoch_300.pth"
resume = True
...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        rule=None,
        max_keep_ckpts=-1),
    pruning_channels=dict(type="mmdlp.AfterTrainPruning", pruning_ratio=0.3, ignore_layers_name=["data_preprocessor", 'head']),
    )
custom_hooks = [
    dict(
        type='EMAHook',
