# 迁移EfficientnetLite模型到mmdlp, https://github.com/RangiLyu/EfficientNet-Lite
import math
import torch
...
class EfficientNetLite0(EfficientNetLite):
    def __init__(self, num_classes=1000, out_indices = [-1]):
        super(EfficientNetLite0, self).__init__(1.0, 1.0, num_classes, 0.2, 0.2)
...
if __name__ == '__main__':
    """
    idx: 1, torch.Size([1, 16, 320, 320])
    idx: 3, torch.Size([1, 24, 160, 160])
    idx: 5, torch.Size([1, 40, 80, 80])
    idx: 8, torch.Size([1, 80, 40, 40])
    idx: 11, torch.Size([1, 112, 40, 40])
    idx: 15, torch.Size([1, 192, 20, 20])
    idx: 16, torch.Size([1, 320, 20, 20])
    """
    model = EfficientNetLite0(out_indices=[5,11,16])
