...
class JointSpaceContrastiveHead(BaseModule):
    """
    """
...
@MODELS.register_module()
class JointSpaceYOLOv8dHeadModule(YOLOv8HeadModule):
    ...
    def _init_layers(self) -> None:
        ...
        # 单独初始化 text embed 到 joint space 的学习
        # 如果超过一层，需要在除去最后一层的其他层添加非线性，这里暂定使用relu
...
@MODELS.register_module()
class JointSpaceYOLOv8Head(YOLOv8Head):
    """
