...
RUN apt update && apt install python3 python3-pip -y && \
    ...
    mim install mmengine==0.10.5 -i https://pypi.tuna.tsinghua.edu.cn/simple && \
    mim install mmcv==2.0.1 -f https://download.openmmlab.com/mmcv/dist/cu116/torch1.13/index.html && \
    mim install mmdet==3.0.0 mmyolo==0.6.0 mmsegmentation==1.2.2 mmpretrain==1.2.0 -i https://pypi.tuna.tsinghua.edu.cn/simple && \
    ...
    pip3 install albumentations==1.3.1 tensorboard==2.12.0 grad-cam==1.4.8 -i https://pypi.tuna.tsinghua.edu.cn/simple && \
